...
from python_portrait_relight.prnet.predictor import PosPrediction
...
class PRN:
    ...
    def __init__(self, 
                 ...
                 uv_kpt_ind_path='data/uv-data/uv_kpt_ind.txt',
        ...
        # uv file
        self.uv_kpt_ind = np.loadtxt(uv_kpt_ind_path).astype(np.int32) # 2 x 68 get kpt
        self.face_ind = np.loadtxt(face_ind_path).astype(np.int32) # get valid vertices in the pos map
        self.triangles = np.loadtxt(triangles_path).astype(np.int32) # ntri x 3
